 ...
 * @author ADmin
 */
public class ChiTietChiNhanhGUI extends javax.swing.JFrame {

    /**
     * Creates new form ChiTietChiNhanhGUI
     */
    
    private ChinhanhBUS khachHangBUS;
    private ChiNhanhGUI root;
    private Vector khachHang;
    private SuaChiNhanhGUI suaChiNhanhGUI;
    
    public ChiTietChiNhanhGUI() {
    ...
    private void chinhSua() {
        dispose();
        suaChiNhanhGUI.run(this, khachHangBUS, khachHang);
    }
    
    private void loadData() {
        Vector khachHangMoi = khachHangBUS.getChiNhanhByMaChiNhanh(khachHang.get(0).toString()).get(0);
    ...
    public void run(ChiNhanhGUI root, ChinhanhBUS khachHangBUS, Vector khachHang) {
        this.root = root;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChiTietChiNhanhGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChiTietChiNhanhGUI().setVisible(true);
            }
        });
    }
